...
function Study() {
  ...
  if (cardCount <= 2) { //if card count is less than 2, returns not enough cards headers, paragraph, and add cards button
    return (
      ...
      <div className="card">
        <h1 className="breadcrumb">{deck.name}: Study</h1>
        <h2 className="mt-3 ml-2">Not Enough Cards</h2>
        <p className="breadcrumb mt-4">You need at least 3 cards to study. There are {cardCount} cards in this deck.</p>
